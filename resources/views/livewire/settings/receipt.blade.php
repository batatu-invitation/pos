...
new #[Layout('components.layouts.app')]
    ...
    public function save()
    {
        ...
        if ($this->logo) {
            ...
            if ($this->logo->getMimeType() === 'image/webp') {
                $this->logo->storeAs('receipt-logos', $filename, 'public');
            } else {
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    <div class="img-container w-full h-[500px]">
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="logo-upload"
                                    ...
                                    @if ($logo)
                                        ...
                                        <div
                                            class="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity z-20 flex items-center justify-center">
                                            <p class="text-base text-white">{{ __('Change') }}</p>
                                        </div>
                                    @elseif($existingLogo)
