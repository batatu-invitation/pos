                        ...
                        <div class="col-span-2 border-t border-gray-100 pt-6 mt-2">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="password" wire:model="new_password_confirmation" class="block w-full rounded-lg border-gray-300 border p-2.5">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="p-4 text-center text-gray-500">No recent activity found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
