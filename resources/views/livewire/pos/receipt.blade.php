...
<div class="h-full w-full flex items-center justify-center p-4">
    ...
    <div id="printable-area" class="hidden print:block bg-white p-4 max-w-[80mm] mx-auto text-black font-mono text-sm">
        ...
        <div class="flex justify-between text-xs mb-2">
            <span>{{ __('Date:') }} {{ now()->format('Y-m-d') }}</span>
            <span>{{ __('Time:') }} {{ now()->format('h:i A') }}</span>
        </div>
        <div class="flex justify-between text-xs mb-2">
            <span>{{ __('Order:') }} #ORD-2023-001</span>
            <span>{{ __('Cashier:') }} Admin</span>
        </div>
    ...
    <div class="max-w-md w-full print:hidden">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
            <div class="bg-green-500 p-8 text-center text-white">
                ...
                <p class="text-green-100 mt-1">{{ __('Transaction') }} #ORD-2023-001</p>
            </div>
            ...
            <div class="p-8">
                ...
                <div class="border-t border-b border-gray-100 py-4 mb-6 space-y-2">
                    ...
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-medium text-gray-900">{{ __('Walk-in Customer') }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600">{{ __('Cashier') }}</span>
                        <span class="font-medium text-gray-900">{{ __('Admin User') }}</span>
                    </div>
                </div>
