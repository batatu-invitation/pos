                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors group">
                        <td class="px-6 py-4 flex items-center">
                            @if($employee->avatar)
                                <img src="{{ $employee->avatar }}" class="w-8 h-8 rounded-full mr-3 object-cover" alt="Avatar">
                            @else
                                <div class="w-8 h-8 rounded-full mr-3 bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-xs">
                        ...
                        <td class="px-6 py-4 text-right">
                            <button wire:click="editEmployee('{{ $employee->id }}')" class="text-indigo-600 hover:text-indigo-900 mr-3 transition-colors">
        ...
        <form x-on:submit.prevent="$dispatch('swal:confirm', {
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-text-input wire:model="firstName" id="firstName" class="block mt-1 w-full" type="text" required />
                ...
                <div>
                    ...
                    <select wire:model="role" id="role" class="border border-gray-300 focus:border-indigo-500 p-4 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                ...
                <div>
                    ...
                    <select wire:model="status" id="status" class="border border-gray-300 p-4 focus:border-indigo-500 p-4 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                ...
                <!-- Password -->
                <div class="md:col-span-2">
                    <x-input-label for="password" value="{{ $editingUserId ? __('Password (leave blank to keep current)') : __('Password') }}" />
